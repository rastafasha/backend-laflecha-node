...
const profileSchema = Schema({
    ...
    blogs: { type: String, require: false, ref: 'Blog' },
    lang: { type: String, required: false },
    precios: { type: Array, required: false },
    rating: { type: String, require: false, ref: 'Comment' },
    especialidad: { type: String, require: false, ref: 'Speciality' },
    documents: { type: String, require: false, ref: 'Document' },
    solicitudes: { type: String, require: false, ref: 'Solicitud' },
